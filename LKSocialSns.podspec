...
Pod::Spec.new do |s|
  ...
  s.source_files  = "LKSocialSns/LKSocialSns/**/*.{h,m}"
  ...
  s.resource_bundles = {
    'LKShareMenu' => ['LKSocialSns/LKSocialSns/ShareMenu/**/*.png', 'LKSocialSns/LKSocialSns/ShareMenu/**/*.jpg', 'LKSocialSns/LKSocialSns/ShareMenu/**/*.xib']
  }
